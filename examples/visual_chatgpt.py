...
def blend_gt2pt(old_image, new_image, sigma=0.15, steps=100):
    ...
    kernel[:steps, :steps] = kernel[:steps, :steps] / kernel[steps - 1,
                                                             steps - 1]
    kernel[:steps,
           -steps:] = kernel[:steps, -steps:] / kernel[steps - 1, -(steps)]
    kernel[-steps:, :steps] = kernel[-steps:, :steps] / kernel[-steps,
                                                               steps - 1]
    kernel[-steps:,
           -steps:] = kernel[-steps:, -steps:] / kernel[-steps, -steps]
    ...
    gaussian_gt_img = kernel * gt_img_array + (1 - kernel) * pt_gt_img
    gaussian_gt_img = gaussian_gt_img.astype(np.int64)
    easy_img[pos_h:pos_h + old_size[1],
             pos_w:pos_w + old_size[0]] = gaussian_gt_img
...
def get_new_image_path(org_img_path, func_name='update'):
    ...
    new_file_name = (f'{this_new_uuid}_{func_name}_'
                     f'{recent_prev_file_name}_{most_org_file_name}.png')
...
class InstructPix2Pix:
    ...
    @prompts(
        ...
        description='useful when you want to the style of the image to '
        'be like the text. '
        'like: make it look like a painting. or make it like '
        'a robot. '
    ...
    def inference(self, inputs):
        ...
        image_path, text = inputs.split(',')[0], ','.join(
            inputs.split(',')[1:])
...
class Text2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate an image from a '
        'user input text and save it to a file. '
        'like: generate an image of an object or something, '
        'or generate an image that includes some objects. '
...
class Image2Canny:
    ...
    @prompts(
        ...
        description='useful when you want to detect the edge of the '
        'image. '
        'like: detect the edges of this image, or canny '
        'detection on image, '
        'or perform edge detection on this image, or detect '
        'the canny image of this image. '
        'The input to this tool should be a string, '
        'representing the image_path')
    def inference(self, inputs):
...
class CannyText2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate a new real image '
        'from both the user description and a canny image.'
        ' like: generate a real image of a object or '
        'something from this canny image,'
        ' or generate a new real image of a object or '
        'something from this edge image. '
        'The input to this tool should be a comma separated '
        'string of two, '
        'representing the image_path and the user '
        'description. ')
    def inference(self, inputs):
...
class Image2Line:
    ...
    @prompts(
        ...
        description='useful when you want to detect the straight line '
        'of the image. '
        'like: detect the straight lines of this image, or '
        'straight line detection on image, '
        'or perform straight line detection on this image, '
        'or detect the straight line image of this image. '
        'The input to this tool should be a string, '
        'representing the image_path')
    def inference(self, inputs):
        image = Image.open(inputs)
...
class LineText2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate a new real image '
        'from both the user description '
        'and a straight line image. '
        'like: generate a real image of a object or '
        'something from this straight line image, '
        'or generate a new real image of a object or '
        'something from this straight lines. '
        'The input to this tool should be a comma separated '
        'string of two, '
        'representing the image_path and the user '
        'description. ')
...
class Image2Hed:
    ...
    @prompts(
        ...
        description='useful when you want to detect the soft hed '
        'boundary of the image. '
        'like: detect the soft hed boundary of this image, '
        'or hed boundary detection on image, '
        'or perform hed boundary detection on this image, '
        'or detect soft hed boundary image of this image. '
        'The input to this tool should be a string, '
        'representing the image_path')
    def inference(self, inputs):
        image = Image.open(inputs)
...
class HedText2Image:
    ...
    @prompts(
        ...
        'like: generate a real image of a object or '
        'something from this soft hed boundary image, '
        'or generate a new real image of a object or '
        'something from this hed boundary. '
        'The input to this tool should be a comma '
        'separated string of two, '
        'representing the image_path and the user '
        'description')
    def inference(self, inputs):
        image_path, instruct_text = inputs.split(',')[0], ','.join(
...
class Image2Scribble:
    ...
    @prompts(
        ...
        description='useful when you want to generate a scribble of '
        'the image. '
        'like: generate a scribble of this image, or '
        'generate a sketch from this image, '
...
class ScribbleText2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate a new real image '
        'from both the user description and '
...
class Image2Pose:
    ...
    @prompts(
        ...
        description='useful when you want to detect the human pose of '
        'the image. '
        'like: generate human poses of this image, or '
        'generate a pose image from this image. '
        'The input to this tool should be a string, '
        'representing the image_path')
    def inference(self, inputs):
        image = Image.open(inputs)
...
class PoseText2Image:
    ...
    @prompts(
        ...
        'like: generate a real image of a human from this '
        'human pose image, '
        'or generate a new real image of a human from '
        'this pose. '
        'The input to this tool should be a comma separated '
        'string of two, '
        'representing the image_path and the user '
...
class SegText2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate a new real '
        'image from both the user description and segmentations. '
        'like: generate a real image of a object or something '
        'from this segmentation image, '
        'or generate a new real image of a object or something '
...
class Image2Depth:
    ...
    @prompts(
        ...
        description='useful when you want to detect depth of the image. '
        'like: generate the depth from this image, '
        'or detect the depth map on this image, or predict '
        'the depth for this image. '
        'The input to this tool should be a string, '
        'representing the image_path')
    def inference(self, inputs):
        image = Image.open(inputs)
...
class DepthText2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate a new real image '
        'from both the user description and depth image. '
        'like: generate a real image of a object or something '
...
class Image2Normal:
    ...
    @prompts(
        ...
        'like: generate normal map from this image, or predict '
        'normal map of this image. '
        'The input to this tool should be a string, '
        'representing the image_path')
    def inference(self, inputs):
        image = Image.open(inputs)
...
class NormalText2Image:
    ...
    @prompts(
        ...
        description='useful when you want to generate a new real image '
        'from both the user description and normal map. '
        'like: generate a real image of a object or something '
        'from this normal map, '
        'or generate a new real image of a object or '
        'something from the normal map. '
        'The input to this tool should be a comma separated '
        'string of two, '
        'representing the image_path and the user description')
    def inference(self, inputs):
...
class VisualQuestionAnswering:
    ...
    @prompts(
        ...
        description='useful when you need an answer for a question '
        'based on an image. '
        'like: what is the background color of the last image, '
        'how many cats in this figure, what is in this figure. '
        'The input to this tool should be a comma separated '
        'string of two, '
        'representing the image_path and the question')
    def inference(self, inputs):
        image_path, question = inputs.split(',')[0], ','.join(
            inputs.split(',')[1:])
...
class Segmenting:
    ...
    def segment_image_with_click(self, img, is_positive: bool,
        ...
        img = self.show_mask(
            masks[0], img, random_color=False, transparency=0.3)
    ...
    def segment_image_with_coordinate(self, img, is_positive: bool,
        ...
        '''
            Args:
                ...
                is_positive: whether the click is positive, if want to add
                    mask use True else False.
                coordinate: the position of the click
                          If the position is (x,y), means click at the x-th
                          column and y-th row of the pixel matrix.
            ...
            Other parameters:
                transparency (float): the transparenccy of the mask
                                      to control he degree of transparency
                                      after the mask is superimposed.
                                      if transparency=1, then the masked part
                                      will be completely replaced with other
                                      colors.
        '''
        self.sam_predictor.set_image(img)
    ...
    @prompts(
        ...
        description='useful when you want to segment all the part of the '
        'image, but not segment a certain object.'
        'like: segment all the object in this image, or generate '
        'segmentations on this image, '
...
class Text2Box:
    ...
    def __init__(self, device):
        ...
        self.device = device
        self.torch_dtype = torch.float16 if 'cuda' in device else torch.float32
        self.model_checkpoint_path = os.path.join('checkpoints',
                                                  'groundingdino')
        self.model_config_path = os.path.join('checkpoints',
                                              'grounding_config.py')
        self.download_parameters()
    ...
    def download_parameters(self):
        ...
        if not os.path.exists(self.model_checkpoint_path):
            wget.download(url, out=self.model_checkpoint_path)
        config_url = 'https://raw.githubusercontent.com/IDEA-Research/' + \
            'GroundingDINO/main/groundingdino/config/' + \
    ...
    @prompts(
        ...
        'The input to this tool should be a comma separated '
        'string of two, '
        'representing the image_path, the text description of '
...
class InfinityOutPainting:
    ...
    def get_BLIP_vqa(self, image, question):
        inputs = self.ImageVQA.processor(
            image, question, return_tensors='pt').to(self.ImageVQA.device,
                                                     self.ImageVQA.torch_dtype)
        out = self.ImageVQA.model.generate(**inputs)
        answer = self.ImageVQA.processor.decode(
            out[0], skip_special_tokens=True)
        return answer

    def get_BLIP_caption(self, image):
        inputs = self.ImageCaption.processor(
            image, return_tensors='pt').to(self.ImageCaption.device,
                                           self.ImageCaption.torch_dtype)
        out = self.ImageCaption.model.generate(**inputs)
        BLIP_caption = self.ImageCaption.processor.decode(
            out[0], skip_special_tokens=True)
        return BLIP_caption
    ...
    def check_prompt(self, prompt):
        check = (f'Here is a paragraph with adjectives. '
                 f'{prompt} '
                 'Please change all plural forms in the adjectives to '
                 'singular forms. ')
    ...
    def resize_image(self, image, max_size=1000000, multiple=8):
        ...
        new_width, new_height = new_width - (new_width %
                                             multiple), new_height - (
                                                 new_height % multiple)
    ...
    def dowhile(self, original_img, tosize, expand_ratio, imagine, usr_prompt):
        ...
        while (old_img.size != tosize):
            prompt = self.check_prompt(
                usr_prompt) if usr_prompt else self.get_imagine_caption(
                    old_img, imagine)
            ...
            resized_temp_canvas, resized_temp_mask = self.resize_image(
                temp_canvas), self.resize_image(temp_mask)
            image = self.inpaint(
                prompt=prompt,
    ...
    @prompts(
        ...
        description='useful when you need to extend an image into a '
        'larger image.'
        'like: extend the image into a resolution of '
        '2048x1024, extend the image into 2048x1024. '
        'The input to this tool should be a comma '
        'separated string of two, representing the '
        'image_path and the resolution of widthxheight')
    def inference(self, inputs):
...
class ObjectSegmenting:
    ...
    @prompts(
        ...
        description='useful when you only want to segment the certain '
        ...
        'The input to this tool should be a comma '
        'separated string of two, '
        'representing the image_path, the text description '
    ...
    def merge_masks(self, masks):
        ...
        if type(masks) == torch.Tensor:
            ...
            raise TypeError('the type of the input masks must be '
...
class ImageEditing:
    ...
    @prompts(
        ...
        description='useful when you want to remove and object or '
        'something from the photo '
        'from its description or location. '
        'The input to this tool should be a comma '
        'separated string of two, '
        'representing the image_path and the object '
        'need to be removed. ')
    ...
    @prompts(
        ...
        description='useful when you want to replace an object from '
        'the object description or '
        'location with another object from its description. '
        'The input to this tool should be a comma separated '
        'string of three, '
        'representing the image_path, the object to be '
        'replaced, the object to be replaced with ')
...
class BackgroundRemoving:
    ...
    def __init__(self, VisualQuestionAnswering: VisualQuestionAnswering,
                 Text2Box: Text2Box, Segmenting: Segmenting):
        self.vqa = VisualQuestionAnswering
        self.obj_segmenting = ObjectSegmenting(Text2Box, Segmenting)

    @prompts(
        name='Remove the background',
        description='useful when you want to extract the object or '
        'remove the background,'
        'the input should be a string image_path')
    def inference(self, image_path):
        """given a image, return the picture only contains the extracted main
        object."""
